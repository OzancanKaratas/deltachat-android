...
You need to use NDK version r22b (22.1.7171670). Versions that are a bit newer
or older will also work, but if you version is too new or too old, you will get
an error like TODO
